      ...
      versions: [
        {
          ...
          user: "Jane Doe",
          changes: "Updated integration specs",
        },
        {
          version: "2.0",
          date: "2024-01-10T09:00:00Z",
          user: "Jane Doe",
          changes: "Added API documentation",
        },
        {
          version: "1.0",
    ...
    },
    {
      ...
      versions: [
        ...
        },
        {
          ...
          user: "Mike Johnson",
          changes: "Added liability clauses",
        },
        {
          version: "3.0",
      ...
      versions: [
        {
          ...
          user: "John Smith",
          changes: "Updated milestone dates",
        },
        {
          version: "1.2",
          date: "2024-01-08T15:30:00Z",
          user: "John Smith",
          changes: "Added resource allocation",
        },
        {
          version: "1.1",
