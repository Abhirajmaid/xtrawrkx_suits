...
export default function ClientDeals({ clientId }) {
  ...
  const deals = [
    {
      ...
      nextSteps: "Project kickoff scheduled for next week",
      source: "website",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Custom analytics dashboard with real-time reporting and data visualization.",
      tags: ["analytics", "dashboard", "custom"],
      products: ["Analytics Pro", "Custom Dashboard", "Data Integration"],
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Client Deals</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div>
                    <div className="text-sm text-gray-500 mb-1">
                      {deal.status === "won" ? "Closed Date" : "Expected Close"}
                    </div>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">
            {searchQuery || selectedFilters.stage !== "all" || selectedFilters.status !== "all" || selectedFilters.owner !== "all"
              ...
              : "No deals associated with this client yet"
            }
          </p>
          <button className="btn-primary">
