...
export default function SalesAnalyticsWidget() {
  ...
  const calculateMetrics = (deals) => {
    ...
    const dealsChange =
      lastMonthDealCount > 0
        ? Math.round(
            ((currentMonthDealCount - lastMonthDealCount) /
              lastMonthDealCount) *
              100
          )
        : currentMonthDealCount > 0
        ? 100
        : 0;
    ...
    const conversionChange =
      lastMonthConversion > 0
        ? Math.round(
            ((currentMonthConversion - lastMonthConversion) /
              lastMonthConversion) *
              100
          )
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-3xl font-black text-gray-800">
                {formatCurrencyCompact(analyticsData.trends.revenue.value)}
              </p>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-white/70 to-white/40 backdrop-blur-xl border border-white/30 shadow-xl p-5 hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-3xl font-black text-gray-800">
                {formatCurrencyCompact(analyticsData.salesVelocity)}
              </p>
              <div className="mt-2 flex items-center text-xs text-gray-500">
