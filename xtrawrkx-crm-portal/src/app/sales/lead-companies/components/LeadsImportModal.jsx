  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (result.success) {
        setImportResult({
          success: true,
          imported: result.imported || result.successful || 0,
          errors: result.errors || result.failed || 0,
          errorsList: result.errorsList || result.errors || [],
        });
        if (onImport) {
          onImport(file);
        }
        ...
        setImportResult({
          success: false,
          error: result.error || "Failed to import lead companies",
        });
      }
    } catch (error) {
      ...
      setImportResult({
        success: false,
        error: error.message || "Failed to import lead companies",
      });
    } finally {
      setImporting(false);
    }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">
                  Import Lead Companies
                </h2>
                <p className="text-sm text-gray-500">
                  Upload CSV or Excel file to import lead companies
                </p>
              </div>
            </div>
            <button
            ...
            <>
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600 mb-2">
                  <strong>All fields are optional.</strong> Missing fields will be set to default values.
                </p>
                <p className="text-xs text-gray-600 mb-1">
                  <strong>Common column names:</strong>
                </p>
                <p className="text-xs text-gray-600">
                  Company Name, Email, Phone, Website, Industry, Status, Address, City, State, Country, Revenue, Employees, Notes
                </p>
                <p className="text-xs text-gray-500 mt-2 italic">
                  If Company Name is missing, it will be generated from email domain or set as "Imported Company [Row Number]"
                </p>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {importing ? "Importing..." : "Import Lead Companies"}
                  </Button>
                </div>
              </div>
            </>
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {importResult.imported} lead companies imported successfully
