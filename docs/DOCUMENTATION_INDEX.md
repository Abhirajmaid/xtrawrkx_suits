...
| **[LANDING_CLIENT_ACCOUNT_SIGNUP_FIX.md](./LANDING_CLIENT_ACCOUNT_SIGNUP_FIX.md)**                         | Fix missing `onboarding_data` column on live signups; schema fields, website signup API path, env vars, Postgres migration                                                     |
| **[EVENT_REGISTRATION_DEADLINE.md](./EVENT_REGISTRATION_DEADLINE.md)**                                   | Landing admin events: registration deadline + enable toggle; public site auto-closes registration on deadline date                                                              |
