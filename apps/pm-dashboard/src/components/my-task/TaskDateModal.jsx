            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-gray-500">
                  {tasksForDate.filter(t => t.status === "Completed" || t.status === "Done").length} completed
                </div>
              </div>
              ...
              {tasksForDate.map((task) => {
                ...
                return (
                  <Card key={task.id} glass={true} className="p-0 overflow-hidden hover:shadow-lg transition-all duration-300">
                    <div className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-start gap-3 flex-1">
                          <div className={`w-8 h-8 ${statusInfo.bgColor} rounded-lg flex items-center justify-center mt-1`}>
                      ...
                      <div className="flex items-center justify-between">
                        <span className={`text-xs px-3 py-1 rounded-full border ${statusInfo.bgColor} ${statusInfo.color}`}>
                          {task.status}
                        </span>
        ...
        {tasksForDate.length > 0 && (
          <div className="flex items-center justify-between p-6 border-t border-white/20 bg-gray-50/50">
            <div className="text-sm text-gray-600">
              {tasksForDate.filter(t => t.status === "Completed" || t.status === "Done").length} of {tasksForDate.length} tasks completed
            </div>
