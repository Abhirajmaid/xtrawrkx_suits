...
export default function Message() {
  ...
  const messages = [
    ...
    },
    {
      id: 2,
      sender: "Jane Cooper",
      content: "I wanted to chat about the new landing page design project. Have you had a chance to review the initial concepts?",
      time: "Jan 27, 2024",
      isMe: false,
      avatar: "JC",
    },
      ...
      <div className="w-80 space-y-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-brand-foreground">Message</h2>
        ...
        <Card glass={true} className="flex-1 flex flex-col p-0 overflow-hidden">
          ...
          <div className="p-4 border-b border-white/20 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-brand-foreground">Message Jane Cooper</h3>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <button className="flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-colors">
                ...
                <span className="text-sm text-brand-foreground">Attach Task</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4">
            {messages.map((message) => (
              ...
              >
                ...
                <div className={`max-w-md ${message.isMe ? 'order-first' : ''}`}>
