  ...
  const documents = [
    {
      ...
      versions: [
        { version: "1.0", date: "2024-01-15T10:30:00Z", user: "John Smith", changes: "Initial version" },
      ],
    },
    {
      id: 2,
      ...
      versions: [
        { version: "2.1", date: "2024-01-14T14:15:00Z", user: "Jane Doe", changes: "Updated integration specs" },
        { version: "2.0", date: "2024-01-10T09:00:00Z", user: "Jane Doe", changes: "Added API documentation" },
        { version: "1.0", date: "2024-01-05T16:30:00Z", user: "Jane Doe", changes: "Initial version" },
      ],
    },
    {
      id: 3,
      ...
      versions: [
        { version: "3.2", date: "2024-01-12T09:20:00Z", user: "Mike Johnson", changes: "Updated terms and conditions" },
        { version: "3.1", date: "2024-01-08T14:00:00Z", user: "Mike Johnson", changes: "Added liability clauses" },
        { version: "3.0", date: "2024-01-01T10:00:00Z", user: "Mike Johnson", changes: "Major revision" },
      ],
    },
    {
      id: 4,
      ...
      versions: [
        { version: "1.3", date: "2024-01-10T11:00:00Z", user: "John Smith", changes: "Updated milestone dates" },
        { version: "1.2", date: "2024-01-08T15:30:00Z", user: "John Smith", changes: "Added resource allocation" },
        { version: "1.1", date: "2024-01-05T12:00:00Z", user: "John Smith", changes: "Added dependencies" },
        { version: "1.0", date: "2024-01-01T09:00:00Z", user: "John Smith", changes: "Initial version" },
      ],
    },
    {
      id: 5,
      ...
      versions: [
        { version: "1.0", date: "2024-01-08T16:45:00Z", user: "Sarah Wilson", changes: "Initial version" },
      ],
    },
  ];
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">
            File repository with versioning and sharing capabilities
          </p>
        </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredDocuments.map((doc) => (
                  <tr key={doc.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        <Version className="w-3 h-3 text-gray-400" />
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">
            {searchQuery || selectedFilters.type !== "all" || selectedFilters.category !== "all"
              ...
              : "No documents associated with this client yet"
            }
          </p>
          <button className="btn-primary">
